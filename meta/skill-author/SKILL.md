...
### 2. Scaffolding
- Use the repository's `scaffold.ps1` script to create the initial structure.
...
- After updating the root `README.md`, run `generate_metadata.ps1` to sync category manifests and READMEs.
...
```powershell
./meta/skill-author/scripts/package.ps1 -SkillPath ./category/skill-folder
```
...
- **Location**: `meta/skill-author/scripts/package.ps1`
- **Usage**: `powershell.exe -File ./meta/skill-author/scripts/package.ps1 -SkillPath <path>`

### generate_metadata.ps1
Synchronizes the root README inventory with category-level manifests.
- **Location**: `generate_metadata.ps1`